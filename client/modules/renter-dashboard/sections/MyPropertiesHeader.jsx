        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-brand-dark text-lg">
              Administra todas tus propiedades registradas ({total})
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
            ...
            <button
              onClick={onRegister}
              className="inline-flex items-center justify-center gap-2 bg-brand-dark text-white px-5 py-2.5 rounded-md font-bold hover:bg-brand-dark/90 transition shadow-md"
            >
