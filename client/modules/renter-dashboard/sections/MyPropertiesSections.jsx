...
const MyPropertiesSections = () => {
  ...
  const handleRegister = () => console.log("Registrar nueva propiedad");
        ...
        {properties.length === 0 ? (
          <div className="text-center py-16">
            ...
            <button
              ...
              className="px-6 py-3 bg-brand-accent text-brand-dark rounded-md font-bold hover:bg-yellow-400 transition shadow-md"
            >
