...
const OwnerPropertyCard = ({ property, onViewDetails, onEdit, onDelete }) => {
  ...
  const displayFeatures = features.filter(
    (f) => f === "Amueblada" || f === "Servicios incluidos"
  );
    ...
    <div className="bg-white font-sans rounded-lg shadow-md overflow-hidden transition duration-300 hover:shadow-lg hover:-translate-y-1 relative">
      ...
      <div className="absolute top-2 right-2 z-10 flex gap-2">
        <button
          ...
          className="p-2 bg-white rounded-full shadow-md hover:bg-yellow-100 transition"
        >
      ...
      <div className="relative">
        ...
        {petFriendly && (
          <div className="absolute bottom-2 left-2 bg-brand-dark text-white text-xs font-bold px-2 py-1 rounded-md">
            Pet Friendly
          </div>
        )}
      ...
      <div className="p-4">
        ...
        <div className="mt-4 flex justify-between items-center">
          ...
          <button
            ...
            className="px-3 py-1 bg-brand-accent text-brand-dark rounded font-medium hover:bg-yellow-400 transition"
          >
            Ver más detalles
          </button>
        </div>
