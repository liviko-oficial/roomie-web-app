...
export const sortProperties = (list, sortBy) => {
  const sorted = [...list];
  switch (sortBy) {
    case "date_desc": return sorted.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));
    case "date_asc": return sorted.sort((a, b) => new Date(a.createdAt) - new Date(b.createdAt));
